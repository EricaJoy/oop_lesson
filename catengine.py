...
def run():
    ...
    setup_images()
    try:
        board = Board(catastrophe.GAME_WIDTH, catastrophe.GAME_HEIGHT)
    except (AttributeError) as e:
        board = Board()
        
    catastrophe.GAME_BOARD = board
    ...
    catastrophe.KEYBOARD = key_handler
    game_window.push_handlers(key_handler)

    try:
        handler = catastrophe.keyboard_handler
